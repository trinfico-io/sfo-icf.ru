...
<div class="site-about">
    ...
    <div class="body-content">
        ...
        <!-- row 1 -->
            ...
            <label for="tab1"
                title="Перевод средств Новому кредитору. В назначении платежа необходимо обязательно указать: номер кредитного договора или Идентификационный номер (номер был выслан Вам смс-сообщением)."
                 style="background: url('/img/qiwi/bank.png') no-repeat left; padding-left:45px;
                    width:49%">Межбанковским переводом по реквизитам</label>

            <input id="tab2" type="radio" name="tabs">
            <label for="tab2" title="Через ВТБ Онлайн" style="background: url('/img/vtb_ico2.png') no-repeat left; padding-left:45px;
                    width:50%">В ВТБ Онлайн</label>
            <? /*
            <input id="tab3" type="radio" name="tabs">
            <label for="tab3" title="За внесение через терминал комиссия не взимается" style="background: url('/img/qiwi/terminal.png') no-repeat left; padding-left:45px;
                    width:38%;">В терминалах платежной сети QIWI без комиссии</label>
            */ ?>
        <!-- end of row 1 -->
        <? /*
        <!-- row 2 -->
            <a class="tabs" style="background: url('/img/qiwi/qiwi.png') no-repeat left; padding-left:45px;
                    width:32.8%;" target="blank" href="https://qiwi.com/payment/form.action?provider=32994">Онлайн на сайте QIWI без комиссии</a>

            <input id="tab5" type="radio" name="tabs">
            <label for="tab5" title="За внесение через терминал комиссия не взимается" style="background: url('/img/svyaznoy/svyaznoy_logo_ico.png') no-repeat left; padding-left:45px;
                    width:33%;">В терминалах сети магазинов Связной</label>

            <input id="tab4" type="radio" name="tabs" >
            <label for="tab4" title="При платеже банковской картой онлайн комиссия не взимается" style="background: url('/img/card_ico2.png') no-repeat left; padding-left:47px; margin-left:5px;
                    width:33%;">Банковской картой онлайн</label>
        <!-- end of row 2 -->
        */ ?>
                	...
                	<p>
                		<ul>
                			...
                			<li><b>Реквизиты счета:</b><br>
                				<ul>
                        			<li><b>р/с:</b>&nbsp;40701810426800000188  в Банк ВТБ (ПАО)</li>
                    ...
                    echo Tabs::widget([
                        'items' => [
                            [
                                ...
                                'content' => $this->render('vtb_trust/_vtb_online'),
                                'active' => true,
                            ],
                            [
                                'label' => 'Через мобильное приложение ВТБ Онлайн',
                                'content' => $this->render('vtb_trust/_vtb_mobile'),
                            ],
                        ],
                    ]);
        ...
        <? /*
            <section id="content-tab4">
                <div>
                    ...
                    <p>Никто, в том числе Финансовая компания СФО ИнвестКредит Финанс, не может получить банковские и персональные данные плательщика.</p>
